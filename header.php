    ...
    <header class="header ">
                ...
                <div class="social">
                    <a href="https://patronite.pl/" target="blank" title="Zostań naszym Patronem">
                        <img src="<?php echo get_template_directory_uri(  ) . '/includes/img/patronite logos-5.png' ?>" alt="Patronite Icon"> </a>
                    <a href="https://www.facebook.com/" target="blank" title=" Profil naFacebooku">
                        <img src="<?php echo get_template_directory_uri(  ) . '/includes\img\fb color.svg ' ?>" alt="Facebook"> </a>
                    <a href="https://support.discord.com/hc/pl" target="blank"
                        title="Dołącz do naszej społeczności na Discordzie">
                        <img src="<?php echo get_template_directory_uri(  ) . '/includes\img\Discord-Logo-Color.svg' ?>" alt="Discord Icon"> </a>
                    <!-- !end of social div -->
                </div>
            </header>
